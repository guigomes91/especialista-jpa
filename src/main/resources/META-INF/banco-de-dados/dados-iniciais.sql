...
insert into produto (id, nome, preco, descricao) values (3, 'Camera GoPro Hero7', 4499.0, 'Melhor camera do mercado, foco e ação!');

insert into cliente (id, nome) values (1, 'Maria');
