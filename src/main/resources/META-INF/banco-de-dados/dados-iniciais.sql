insert into produto (id, versao, nome, preco, data_criacao, descricao, ativo) values (1, 0, 'Kindle', 799.0, (now() - interval '1 day'), 'Conheça o novo Kindle, agora com iluminação embutida ajustável, que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia.', 'SIM');
insert into produto (id, versao, nome, preco, data_criacao, descricao, ativo) values (3, 0, 'Camera GoPro Hero7', 1400.0, (now() - interval '1 day'), 'Melhor camera do mercado, foco e ação!', 'SIM');
insert into produto (id, versao, nome, preco, data_criacao, descricao, ativo) values (4, 0, 'Câmera Canon 80D', 3500.0, now(), 'O melhor ajuste de foco.', 'SIM');
insert into produto (id, versao, nome, preco, data_criacao, descricao, ativo) values (5, 0, 'Microfone de Lapela', 50.0, now(), 'Produto massa', 'NAO');
...
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (1, 0, 1, now(), 2398.0, 'AGUARDANDO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (2, 0, 1, now(), 499.0, 'AGUARDANDO');
...
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (5, 0, 2, (now() - interval '2 day'), 799.0, 'PAGO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (6, 0, 2, now(), 799.0, 'AGUARDANDO');
insert into pedido (id, versao, cliente_id, data_criacao, total, status) values (7, 0, 3, now(), 200.0, 'AGUARDANDO');
